...
type NewApplication struct {
	...
	Sex               Sex                    `xml:"sex"`
	Citizenship       Country            `xml:"citizenship"`
	...
	LaCountry         Country            `xml:"la_country"`
	...
	RaCountry         Country            `xml:"ra_country"`
	...
	BaCountry         Country            `xml:"ba_country"`
	...
	PosCountry        Country            `xml:"pos_country"`
