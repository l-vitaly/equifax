...
type AddressReg struct {
	...
	Country   Citizenship  `xml:"country"`                  // страна
...
type ApplicationIndividual struct {
	...
	Citizenship     Citizenship `xml:"citizenship,omitempty"`      // гражданство
...
type LegalEntity struct {
	...
	RegCountry  Citizenship `xml:"regcountry"`            // наименование государства регистрации
